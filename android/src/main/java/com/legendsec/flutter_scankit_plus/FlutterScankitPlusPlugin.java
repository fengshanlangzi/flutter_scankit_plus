package com.legendsec.flutter_scankit_plus;
...
/** FlutterScankitPlusPlugin */
public class FlutterScankitPlusPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    mChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "com.legendsec.flutter_scankit_plus/scan");
    mChannel.setMethodCallHandler(this);
    mResultChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "com.legendsec.flutter_scankit_plus/result");
