...
import 'flutter_scankit_plus.dart';
...
class ScanKitController {
  ...
  ScanKitController() {
    var eventChannel = EventChannel('com.legendsec.flutter_scankit_plus/event');

    _eventSubscription = eventChannel.receiveBroadcastStream()
        .listen(_eventHandler,cancelOnError: false);

    _channel = const MethodChannel('com.legendsec.flutter_scankit_plus/ScanKitWidget');
  }
