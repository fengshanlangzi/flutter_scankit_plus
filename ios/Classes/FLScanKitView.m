...
-(void)setupFlutterChannel:(NSObject<FlutterBinaryMessenger>*)messenger{
    FlutterMethodChannel* channel = [FlutterMethodChannel
        methodChannelWithName:@"com.legendsec.flutter_scankit_plus/ScanKitWidget"
    ...
    _eventChannel = [FlutterEventChannel eventChannelWithName:@"com.legendsec.flutter_scankit_plus/event" binaryMessenger:messenger];
...
//    HmsScanOptions *options = [[HmsScanOptions alloc] initWithScanFormatType:[FLScanKitUtilities getScanFormatType:scanTypes] Photo:FALSE];
    ...
    customScanVC = [[QAXQRCodeVC alloc] init];
